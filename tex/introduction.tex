...
The goal of this thesis is to asses different implementations methods to achieve the best possible voice transformation, \ie synthesis a new natural voice which is similar to the target voice. \TODO{more...}
