...
\newcommand{\Auto}{\boldsymbol \Gamma}
\begin{definition}
	Given a vector $\mathbf{a} = [a_0, a_1,\dots, a_{n-1}]$, The Toeplitz matrix $\ttt$ of $\mathbf{a}$ is then 
	\begin{equation}
		\ttt(\mathbf{a}) = 
		\begin{bmatrix}
		a_0 & a_1 & \dots & a_{n-1} 	\\
